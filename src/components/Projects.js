...
import {
    faEnvelopeOpenText, faUserEdit, faUserPlus, faUsersCog, faUserTimes,
    faUsers, faUserTag, faBriefcase, faCommentDollar
} from "@fortawesome/free-solid-svg-icons";
import {getProjectsForCompany} from "../api/getProjectsForCompany";
...
export default class Projects extends Component {
    ...
    componentDidMount() {
        ...
        if (sessionStorage.getItem("roles").includes("COMPANY")) {
        ...
        } else if (sessionStorage.getItem("roles").includes("INVESTOR")) {
            getInvestor(null, sessionStorage.getItem("username"))
                .then((response) => {
                    this.setState({items: response.data.investments, isLoading: false})
                    console.log(response.data);
                })
                .catch(error => {
                    console.log("Error *** : " + error);
